...
def config_aggrid(
    ...
    gb.configure_column("desc", wrapText =  True, autoHeight = True, editable=True, width=320)
    gb.configure_column("usage", wrapText =  True, autoHeight = True, editable=True, width=240)
