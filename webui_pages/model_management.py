...
def config_aggrid(
    ...
    gb.configure_column("desc", wrapHeaderText=  True, autoHeaderHeight= True, editable=True)
    gb.configure_column("usage", wrapHeaderText=  True, autoHeaderHeight= True, editable=True)
