...
LLM_MODELS = ["Qwen2-7B-Instruct", "Qwen1.5-7B-Chat", "Qwen-1.8B-Chat", "chatglm3-6b-32k"] # ["chatglm2-6b", "zhipu-api", "openai-api"] "Qwen-14B-Chat",, "chatglm3-6b"


# AgentLM模型的名称 (可以不指定，指定之后就锁定进入Agent之后的Chain的模型，不指定就是LLM_MODELS[0])
Agent_MODEL = "Qwen2-7B-Instruct" # "Qwen1.5-7B-Chat" #"chatglm3-6b-32k" #"Qwen1.5-7B-Chat"
LONG_CONTEXT_MODEL = "Qwen2-7B-Instruct" # "chatglm3-6b-32k" #"Qwen1.5-7B-Chat"# "chatglm3-6b-32k"
