...
@deprecated(
    since="0.3.0",
    message="模型启动功能将于 0.3.x重写,支持更多模式和加速启动，0.2.x中相关功能将废弃",
    removal="0.3.0")
...
def create_model_worker_app(log_level: str = "INFO", **kwargs) -> FastAPI:
    ...
    # 本地模型
        ...
        if kwargs["model_names"][0] in VLLM_MODEL_DICT and args.infer_turbo == "vllm":
            ...
            print(f"Loading the model [{model}] use vllm worker.......................................")
            ...
            model = kwargs["model_names"][0]
            print(f"Loading the model [{model}] use plain worker.......................................")
...
def dump_server_info(after_start=False, args=None):
    ...
    print("\n")
    print("=" * 30 + "Chatchat Configuration" + "=" * 30)
